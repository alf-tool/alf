...
Gem::Specification.new do |s|
  ...
  s.add_dependency("alf-sql", "~> 0.17")
  s.add_dependency("alf-sequel", "~> 0.17")
  s.add_dependency("alf-shell", "~> 0.17")
  s.add_dependency("alf-rack", "~> 0.17")
  s.add_dependency("alf-repl", "~> 0.16")
